...
For the development stack (Docker compose with Postgres + Odoo + headless Chrome for tests), see the [`19.0.dev`](https://github.com/naimoudayet/Clear-All-Filters/tree/19.0.dev) branch.
