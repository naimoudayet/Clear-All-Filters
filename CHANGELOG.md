...
All notable changes to **Clear All Filters Button** for Odoo 17.0 are documented here.

This file follows the [Keep a Changelog](https://keepachangelog.com/en/1.1.0/) format.
Versions use Odoo's `<odoo_version>.<module_major>.<module_minor>.<module_patch>` scheme.

## [17.0.1.2.1] - 2026-06-02
...
- Module version bumped from `17.0.1.1.0` to `17.0.1.2.0` (semver minor for new language).
...
- Module version bumped from `17.0.1.0.0` to `17.0.1.1.0`.
