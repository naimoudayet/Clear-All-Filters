...
![Version](https://img.shields.io/badge/version-17.0.1.2.1-informational)
...
For the development stack (Docker compose with Postgres + Odoo + headless Chrome for tests), see the [`17.0-dev`](https://github.com/naimoudayet/Clear-All-Filters/tree/17.0-dev) branch.
